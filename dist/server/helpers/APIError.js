 ...
 * @extends Error
 */
const ExtendableError = (function (_Error) {
...
const APIError = (function (_ExtendableError) {
    ...
    function APIError(message) {
        const status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _httpStatus2.default.INTERNAL_SERVER_ERROR;
        const isPublic = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
